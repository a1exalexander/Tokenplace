  ...
  <div class="exchange" @click.self="visible.dropMenu = false">
      ...
      >
        ...
        >
          <div class="api-item" v-for="(item, index) in myApi" :key="item.id">
            ...
            <button class="api-item__delete" @click="_deleteApi(index)">
    ...
    <div class="exchange__box" @click.self="visible.dropMenu = false">
      <div class="exchange__box-inner" @click.self="visible.dropMenu = false">
        ...
        <div class="exchange__drop-menu" @click.self="visible.dropMenu = !visible.dropMenu">
          <p
            class="exchange__drop-placeholder"
          >{{ dropList.select?dropList.select:"Choose an exchange"}}</p>
          <icon-angle-down
      ...
      <div class="exchange__field" @click="visible.dropMenu = false">
        ...
        >
          <div class="api-box" v-for="(item, index) in apiBox" :key="item.id">
            ...
            <input
              class="api-box__input api-box__input--api"
              type="text"
              placeholder="API Key"
              v-model.trim="item.api"
            >
            <input
              class="api-box__input api-box__input--key"
              type="text"
              placeholder="Secret Key"
              v-model.trim="item.key"
            >
            <button
              class="api-box__button-save"
...
export default {
  ...
  methods: {
    ...mapActions('exchangesApi', ['addApi', 'deleteApi']),
    ...mapMutations('dashboard', ['setLastActivity']),
    selectDropItem(name) {
  ...
  computed: {
    ...
    ...mapGetters('exchangesApi', ['getApiNames']),
  },
};
</script>
