      ...
      <section class="buy-plan__row">
        <section class="buy-plan__col buy-plan__col--form">
          ...
          <div class="buy-plan__form">
            <label
              for="card-input"
              class="buy-plan__label buy-plan__label--card-label">Card number
            </label>
            ...
            <label
              for="country-input"
              class="buy-plan__label buy-plan__label--country-label"
            >Country</label>
            <label
              for="index-input"
              class="buy-plan__label buy-plan__label--country-label">Country
            </label>
            <label
              for="-input"
              class="buy-plan__label buy-plan__label--index-label">Index
            </label>
            <input
              id="card-input"
              type="text"
              ...
              :class="{
                'input-error': !status.cardNumber && inputValues.cardNumber,
                'input-accepted': status.cardNumber
              }"
            ...
            <div class="buy-plan__input-wrapper buy-plan__input-wrapper--expiries-m">
              ...
              <input
                ...
                :class="{
                  'input-error': !checkExpiriesMonth && inputValues.expiriesMonth,
                  'input-accepted': checkExpiriesMonth
                }"
            ...
            <div class="buy-plan__input-wrapper buy-plan__input-wrapper--expiries-y">
              ...
              <input
                ...
                :class="{
                  'input-error': !checkExpiriesYear && inputValues.expiriesYear,
                  'input-accepted': checkExpiriesYear
                }"
            ...
            <input
              ...
              :class="{
                'input-error': !status.securityCode1 && inputValues.securityCode1,
                'input-accepted': status.securityCode1
              }"
              v-model="inputValues.securityCode1"
            >
            <input
              type="text"
              id="securityCode-2"
              ...
              :class="{
                'input-error': !status.securityCode2 && inputValues.securityCode2,
                'input-accepted': status.securityCode2
              }"
              v-model="inputValues.securityCode2"
            >
            <input
              type="text"
              id="securityCode-3"
              ...
              :class="{
                'input-error': !status.securityCode3 && inputValues.securityCode3,
                'input-accepted': status.securityCode3
              }"
              v-model="inputValues.securityCode3"
            >
            <div
              class="buy-plan__input buy-plan__input--country"
            ...
            <input
              ...
              :class="{
                'input-error': !checkIndex && inputValues.index,
                'input-accepted': checkIndex
              }"
          ...
          <div class="buy-plan__check-wrapper">
            ...
            <p class="buy-plan__check-text">
              I agree to the
              <a
                href="#"
                class="buy-plan__check-text buy-plan__check-text--link"
              >Tokenplace Terms</a>
              and the
              <a
                href="#"
                class="buy-plan__check-text buy-plan__check-text--link"
              >Automatic Renewal Terms</a>
              above
            </p>
          </div>
        </section>
...
export default {
  ...
  methods: {
    ...
    checkSecurity(num) {
      const code = this.inputValues[`securityCode_${num}`];
      if (code) {
    ...
    checkCardNumber() {
      const value = this.inputValues.cardNumber;
      if (value) {
    ...
    ...mapMutations('settings', ['setPlan']),
    isNumeric(value) {
      return !Number.isNaN(parseFloat(value)) && Number.isFinite(value);
    },
    formatCardNumber() {
      const code = this.inputValues.cardNumber;
      if (code) {
        ...
        if (codeLength === 4) {
          ...
          const flag = arr.every(el => this.isNumeric(el));
          if (flag) {
            arr.splice(4, 0, ' ');
            arr.splice(9, 0, ' ');
            arr.splice(14, 0, ' ');
  ...
  watch: {
    // eslint-disable-next-line
    'inputValues.securityCode1'() {
      this.checkSecurity(1);
    },
    // eslint-disable-next-line
    'inputValues.securityCode2'() {
      this.checkSecurity(2);
    },
    // eslint-disable-next-line
    'inputValues.securityCode3'() {
