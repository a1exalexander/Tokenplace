<template>
  <main class="affiliate">
    <section class="affiliate__header">
      ...
      <p
        class="affiliate__text"
      >Share the experience of trading done right with the Bitsgap Referral Affiliate Program.
        <br>If you like using Bitsgap, please help us to grow. Invite your friends.
        <br>Your support is the best sign that we are doing a right thing.
      </p>
    </section>
    <section class="affiliate__section">
      ...
      <div class="affiliate__row affiliate__row--margin">
        <input
          ...
          readonly
        >
        <input type="hidden" id="referral-link" :value="link" readonly>
        <button class="affiliate__button" @click="copy">Copy</button>
      </div>
      <div class="affiliate__row">
        <a href="#" class="affiliate__social">
          <icon-twitter class="affiliate__social-ico"/>
        </a>
        <a href="#" class="affiliate__social affiliate__social--margin">
    ...
    <section class="affiliate__section affiliate__section--referral">
      ...
      <div class="referral">
        <div class="referral__row referral__row--heading">
          <p class="referral__text referral__text--heading referral__text--right">
            Sign-ups:
            <span class="referral__text referral__text--bold">13</span>
          </p>
        </div>
        <div class="referral__row referral__row--head">
          <button class="referral__text referral__text--head" @click="sort('email')">EMAIL
            <icon-angle-down
              class="referral__ico"
              :class="{
                'sort-image-active': status.email.direction,
                'sort-active-arrow': status.email.active}"
            />
          </button>
          <button
...
export default {
  ...
  methods: {
    ...mapActions('settings', ['getReferralHistory']),
    ...mapMutations('settings', ['sortReferralHistory', 'sortReferralHistoryDates']),
    copy() {
