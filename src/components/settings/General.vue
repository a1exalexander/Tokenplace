  ...
  <main class="setting-general">
    ...
    <section class="setting-general__section">
      <div class="setting-general__inner">
        ...
        <div
          class="setting-general__input setting-general__input--currency"
          @click="currency.dropMenu = !currency.dropMenu"
        >
          <p class="setting-general__placeholder">{{ currentCurrency }}</p>
          <icon-angle-down
            class="setting-general__input-ico"
            :class="{'image-rotate': currency.dropMenu}"
          />
          <transition
          ...
          >
            <div class="setting-general__drop-list" v-if="currency.dropMenu">
              <p
                class="setting-general__drop-item"
                v-for="(item, index) in currency.list"
                :key="index"
                @click="setDefaultCurrency(item)"
              >{{ item }}</p>
            </div>
          </transition>
        </div>
      ...
      <div class="setting-general__inner setting-general__inner--margin">
        ...
        <div
          class="setting-general__input setting-general__input--language"
      ...
      <div class="setting-general__inner">
        ...
        <div
          class="setting-general__input setting-general__input--timezone"
    ...
    <section class="setting-general__section setting-general__section--notification">
      ...
      <div class="setting-general__buttons-wrapper">
        ...
        <router-link
          to="/dashboard"
          class="setting-general__button setting-general__button--cancel"
        >Cancel</router-link>
      </div>
    </section>
  </main>
...
export default {
  ...
  methods: {
    ...mapMutations('settings', ['setDefaultZone', 'setDefaultLanguage', 'setDefaultCurrency']),
    getTimeZones() {
