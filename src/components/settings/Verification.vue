...
<main class="verification">
	...
	<section 
		...
		<p class="verification__text">We will only use the information you enter to verify who you are, and we'll only hold onto it untill your account issue is resolved
		</p>
	</section>
	<section 
		class="verification__section"
		...
		<p class="verification__text">We'll notify you by email once your submission has been reviewed
		</p>
	</section>
	<section 
		class="verification__container"
		v-else>
		...
		<section class="verification__section verification__section--upload">
			<div 
				class="verification__upload-image-wrapper"
				v-if='dataInput.passport'>
			...
			<label class="verification__upload-button">
				...
				<icon-upload 
					class="verification__upload-ico"
					v-if='!dataInput.passport'/>
				<p class="verification__upload-text">
					{{ dataInput.passport? "Change image": "Upload a passport scan" }}
				</p>
			</label>
		</section>
		<section class="verification__section verification__section--upload">
			...
			<label class="verification__upload-button">
				...
				<icon-upload 
					...
					v-if='!dataInput.selfie'/>
				<p class="verification__upload-text">
					{{ dataInput.selfie? "Change image": "Upload selfie with a passport" }}
				</p>
			</label>
		</section>
