...
<section class="new-support">
	<article class="new-support__card animated delay-01 fadeIn dur08">
		<button 
			class="new-support__button-close"
			@click='cancel'>
		...
		<p class="new-support__heading">Send a new message 
		</p>
		<form class="new-support__form">
			<label class='new-support__label'>
				<p class="new-support__label-text">Theme
				</p> 
				<input 
				type="text" 
			...
			<label class='new-support__label'>
				<p class="new-support__label-text">Message
				</p>
				<textarea 
					type="tex" 
