  ...
  <table class="dashboard-trades-table">
    <thead class="dashboard-trades-table__thead">
      <tr class="dashboard-trades-table__row dashboard-trades-table__row--head">
        <th
          class="dashboard-trades-table__cell
            dashboard-trades-table__cell--head
        ...
        <th
          class="dashboard-trades-table__cell
            dashboard-trades-table__cell--right
            dashboard-trades-table__cell--head"
        >
...
export default {
  ...
  methods: {
    // TODO: this function must be replaced by Http request
    pushBalance() {
      const data = {
        currency: '',
        total: '',
