		...
		<ul class="nav__list">
			<li class="nav__item">
				<router-link 
					to="/dashboard" 
					class="nav__link" 
					:class="{'nav__link--active': 'dashboard' == route || 'home' == route}">dashboard
				</router-link>
			</li>
			<li class="nav__item">
				<router-link 
					to='/trading' 
					class="nav__link" 
					:class="{'nav__link--active': 'trading' == route}">trading
				</router-link>
			</li>
			<li class="nav__item">
				<router-link 
					to='/portfolio' 
					class="nav__link" 
					:class="{'nav__link--active': 'portfolio' == route}">portfolio
				</router-link>
			</li>
			<li class="nav__item">
				<router-link 
					to='/exchanges' 
					class="nav__link" 
					:class="{'nav__link--active': 'exchanges' == route}">my exchanges
				</router-link>
			</li>
			<li class="nav__item">
				<router-link 
					to='/support' 
					class="nav__link" 
					:class="{'nav__link--active': 'support' == route}">support
				</router-link>
			</li>
		</ul>
	</div>
			...
			<div class="nav__drop-list" v-show='navDrop'>
				<div class="nav__drop-list-inner">
					<router-link to='/settings' class="nav__drop-item">
						<icon-gear class="nav__drop-item-ico"/>
						Settings
					</router-link>
					<a href='#' @click.prevent="logout" class="nav__drop-item">
						<icon-log-out class="nav__drop-item-ico nav__drop-item-ico--logout"/>
						Log out
					</a>
				</div>
			</div>
