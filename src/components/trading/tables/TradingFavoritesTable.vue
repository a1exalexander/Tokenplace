...
<section class="trading-favorites-table__wrapper">
	<label class="trading-favorites-table__search">
		...
		<input type="text" 
			class="trading-favorites-table__search-input" placeholder="Search..." 
			v-model='searchChars'>
	</label>
	<table class="trading-favorites-table">
		<thead class="trading-favorites-table__thead">
			<tr class="trading-favorites-table__row">
				<th 
					class="trading-favorites-table__cell trading-favorites-table__cell--pair trading-favorites-table__cell--head"
				...
				<th 
					class="trading-favorites-table__cell trading-favorites-table__cell--price trading-favorites-table__cell--head"
				...
				<th 
					class="trading-favorites-table__cell trading-favorites-table__cell--hours trading-favorites-table__cell--head"
		...
		<tbody class="trading-favorites-table__tbody">
			<tr class="trading-favorites-table__row" v-for='item in getFavorites' :key='item.id'>
				<td class="trading-favorites-table__cell trading-favorites-table__cell--pair trading-favorites-table__cell--star"
				@click="deleteFavorite(item.id)">
					<icon-star class="trading-favorites-table__star"/>
					{{ item.pair }}
				</td>
				<td class="trading-favorites-table__cell trading-favorites-table__cell--price">{{ item.price }}</td>
				<td class="trading-favorites-table__cell trading-favorites-table__cell--hours">{{ item.hours }}</td>
			</tr>
		</tbody>
	</table>
</section>
	...
	computed: {
		...
		getFavorites() {
			...
			if(chars && this.validChars(chars)) {
				...
				return this.favorites.filter(el => {
