...
<table class="trading-open-order-table">
	<thead class="trading-open-order-table__thead">
		<tr class="trading-open-order-table__row">
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--pair"
			...
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--type"
			...
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--exchange"
			...
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--amount"
			...
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--price"
			...
			<th 
				class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--date"
				@click="sortDates('date')">date
				<icon-arrow-up 
					class='trading-open-order-table__head-img'
					:class='{"sort-image-active": status.date.direction, "sort-active-arrow": status.date.active}'/>
			</th>
			<th class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--edit"></th>
			<th class="trading-open-order-table__cell trading-open-order-table__cell--head trading-open-order-table__cell--decline"></th>
		</tr>
	</thead>
	<tbody class="trading-open-order-table__tbody">
		<tr class="trading-open-order-table__row" v-for='(item, index) in getOpenOrders' :key='index'>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--pair">{{ item.pair }}</td>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--type">{{ item.type }}</td>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--exchange">{{ item.exchange }}</td>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--amount">{{ item.amount }}</td>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--price">{{ item.price }}</td>
			<td class="trading-open-order-table__cell trading-open-order-table__cell--date">{{ item.date }}</td>
	...
	computed: {
		...
		getOpenOrders() {
			...
			if(chars && this.validChars(chars)) {
				...
				return this.openOrders.filter(el => {
