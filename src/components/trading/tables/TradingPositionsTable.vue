  ...
  <table class="trading-positions-table">
    <thead class="trading-positions-table__thead">
      <tr class="trading-positions-table__row">
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--pair"
          @click="sort('pair')"
        >pair
          <icon-arrow-up
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--type"
          @click="sort('type')"
        >type
          <icon-arrow-up
            class="trading-positions-table__head-img"
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--exchange"
          @click="sort('exchange')"
        >exchange
          <icon-arrow-up
            class="trading-positions-table__head-img"
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--amount"
          @click="sort('amount')"
        >amount
          <icon-arrow-up
            class="trading-positions-table__head-img"
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--price"
          @click="sort('price')"
        >price
          <icon-arrow-up
            class="trading-positions-table__head-img"
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--date"
        ...
        <th
          class="trading-positions-table__cell
            trading-positions-table__cell--head
            trading-positions-table__cell--profit"
          @click="sort('profit')"
        >profit
          <icon-arrow-up
            class="trading-positions-table__head-img"
            :class="{
              'sort-image-active': status.profit.direction,
              'sort-active-arrow': status.profit.active
            }"
          />
        </th>
      </tr>
    ...
    <tbody class="trading-positions-table__tbody">
      <tr class="trading-positions-table__row" v-for="(item, index) in getPositions" :key="index">
        <td
          class="trading-positions-table__cell trading-positions-table__cell--pair"
        >{{ item.pair }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--type"
        >{{ item.type }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--exchange"
        >{{ item.exchange }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--amount"
        >{{ item.amount }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--price"
        >{{ item.price }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--date"
        >{{ item.date }}</td>
        <td
          class="trading-positions-table__cell trading-positions-table__cell--profit"
        >{{ item.profit }}</td>
      </tr>
    </tbody>
  </table>
...
export default {
  ...
  computed: {
    ...mapState('trading', ['positions']),
    getPositions() {
      const chars = this.searchChars;
      if (chars && this.validChars(chars)) {
        const re = new RegExp(chars, 'gi');
        return this.positions.filter(el => el.pair.match(re));
      }
      return this.positions;
    },
  },
  methods: {
    ...mapActions('trading', ['sortPositions', 'sortPositionsDates']),
    validChars(chars) {
