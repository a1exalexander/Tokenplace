...
<section class="trading-time-box">
	<div class="trading-time-box__toggle-box">
		<button class="trading-time-box__toggle-button" :class="{'toggle-button-active': timeTables.pairs}" @click="chooseTimeTable('pairs')">Pairs</button>
		<button class="trading-time-box__toggle-button" :class="{'toggle-button-active': timeTables.favorites}" @click="chooseTimeTable('favorites')">Favorites</button>
		<button class="trading-time-box__toggle-button" :class="{'toggle-button-active': timeTables.recent}" @click="chooseTimeTable('recent')">Recent Trades</button>
	</div>
	<div class="trading-time-box__field">
		...
		<trading-favorites-table :search-chars='searchChars' v-else-if="timeTables.favorites" key='favorites'/>
