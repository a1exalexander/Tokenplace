	...
	<form class="sign-up__card">
		...
		<label class="sign-up__label">
			...
			<input 
				...
				:class="{'input-error': !checkName && signUpData.name, 'input-accepted': checkName}"
				autocomplete="on"
		...
		<label class="sign-up__label">
			...
			<input 
				type="email" 
				class="sign-up__input" 
				:class="{'input-error': !checkEmail && signUpData.email, 'input-accepted': checkEmail}"
				autocomplete="on" 
		...
		<label class="sign-up__label">
			...
			<input 
				type="password" 
				class="sign-up__input" 
				:class="{'input-error': !checkPassword && signUpData.password, 'input-accepted': checkPassword}"
				autocomplete="off" 
				v-model.trim="signUpData.password">
		</label>
		<label class="sign-up__check-label">
			<input 
				class="sign-up__check-default" 
				type="checkbox" 
				v-model="statusAgree">
			<div class="sign-up__check">
				<icon-check class="sign-up__check-img"/>
			</div>
			<p class="sign-up__check-text">I agree to
				<a 
		...
		<button 
			...
			:disabled='showButton' 
			@click.prevent='signUp'>Sign Up
		</button>
	</form>
	<p class="sign-up__subtext">Already have an account?
		<a href="#" class="sign-up__sublink"  @click.prevent='toSignIn()'>Log In</a>
	</p>
</section>
</template>
<script>
