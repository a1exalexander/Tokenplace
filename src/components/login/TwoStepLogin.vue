...
<article class="two-step-login">
	...
	<p class="two-step-login__text">To confirm that you are the owner of the page, please write a code from the Google Authenticator App
	</p>
	...
	<label class="two-step-login__label">
		...
		<label class="two-step-login__check-label">
			<input 
				class="two-step-login__check-default" 
				type="checkbox" 
				v-model="dontAsk">
